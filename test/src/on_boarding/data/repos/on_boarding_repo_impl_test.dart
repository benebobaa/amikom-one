...
import 'package:flutter_amikomone/core/errors/exceptions.dart';
import 'package:flutter_amikomone/core/errors/failures.dart';
import 'package:flutter_amikomone/src/on_boarding/data/datasources/on_boarding_local_data_source.dart';
import 'package:flutter_amikomone/src/on_boarding/data/repos/on_boarding_repo_impl.dart';
...
void main() {
  ...
  test('should be a class of [OnBoardingRepo]', () {
    expect(repoImpl, isA<OnBoardingRepo>());
  });

  group('cacheFirstTimer', () {
    test(
        'should complete successfully when call to local source is successfully',
        () async {
